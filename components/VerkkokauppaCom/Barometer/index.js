...
const VerkkokauppaComBarometerGraph = () => (
    <svg
        className={styles.priceBarometerGraph}
        width="1920"
        height="120"
...
const VerkkokauppaComBarometer = () => (
    <section className={styles.priceBarometer}>
        ...
        <div className={styles.priceBarometerText}>
            <h2 className={styles.heading}>Making Informed Customers</h2>
...
export { VerkkokauppaComBarometer as default }
