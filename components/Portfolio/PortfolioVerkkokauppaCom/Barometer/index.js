...
const VerkkokauppaComBarometerGraph = () => (
    <svg
        className={s.priceBarometerGraph}
        width="1920"
        height="120"
...
export const VerkkokauppaComBarometer = () => (
    <section className={s.priceBarometer}>
        <img
            className={s.priceBarometerImage}
            src={barometer1x}
            srcSet={`${barometer1x} 1x, ${barometer2x} 2x, ${barometer3x} 3x`}
        />
        <VerkkokauppaComBarometerGraph />
        <div className={s.priceBarometerText}>
            <h2 className={s.heading}>Making Informed Customers</h2>
