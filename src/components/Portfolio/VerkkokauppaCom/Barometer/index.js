...
import { default as barometer1x } from "./price-barometer.png";
import { default as barometer2x } from "./price-barometer@2x.png";
import { default as barometer3x } from "./price-barometer@3x.png";
    ...
    <Section>
      ...
      <Text>
        ...
        <p>
          ...
          being probably always cheaper.
        </p>
        <p>
          To empower customers in their self-service shopping we created a way
          to estimate the price fluctuations of products. Customers are able to
          judge themselves how much cheaper Verkkokauppa.com is. We also tell
          customers the value of their product as used-goods, so they can be
          confident reselling and fighting e-waste.
        </p>
      </Text>
    </Section>
  );
