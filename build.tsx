...
import { Router, pagesRouter } from "./src/router.tsx";
...
await Promise.all(
  Object.keys(pagesRouter.routes).map(async (route) => {
...
const prettier = Bun.spawnSync(["oxfmt", "--write", ...buildFiles, headersFile]);
